...
{
    class SizeGrip;
    class Decoration : public KDecoration2Lim::Decoration
    {
        Q_OBJECT
        ...
        KDecoration2Lim::DecorationButtonGroup *m_leftButtons = nullptr;
        KDecoration2Lim::DecorationButtonGroup *m_rightButtons = nullptr;
        ...
        friend class DecorationLim;
        friend class ButtonLim;
