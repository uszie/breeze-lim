...
namespace Breeze
{
    ...
    class Button : public KDecoration2Lim::DecorationButton
    {
        Q_OBJECT
        ...
        //* private constructor
        explicit Button(KDecoration2Lim::DecorationButtonType type, Decoration *decoration, QObject *parent = nullptr);
