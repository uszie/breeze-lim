...
namespace Breeze
{
    ...
    using KDecoration2Lim::ColorRole;
    using KDecoration2Lim::ColorGroup;
    ...
    Decoration::Decoration(QObject *parent, const QVariantList &args)
        : KDecoration2Lim::Decoration(parent, args)
    ...
    void Decoration::init()
    {
        ...
        connect(c, &KDecoration2Lim::DecoratedClient::adjacentScreenEdgesChanged, this, &Decoration::recalculateBorders);
        connect(c, &KDecoration2Lim::DecoratedClient::maximizedHorizontallyChanged, this, &Decoration::recalculateBorders);
        connect(c, &KDecoration2Lim::DecoratedClient::maximizedVerticallyChanged, this, &Decoration::recalculateBorders);
        connect(c, &KDecoration2Lim::DecoratedClient::shadedChanged, this, &Decoration::recalculateBorders);
        connect(c, &KDecoration2Lim::DecoratedClient::captionChanged, this,
            [this]()
            {
        ...
        connect(c, &KDecoration2Lim::DecoratedClient::activeChanged, this, &Decoration::updateAnimationState);
        connect(c, &KDecoration2Lim::DecoratedClient::widthChanged, this, &Decoration::updateTitleBar);
        connect(c, &KDecoration2Lim::DecoratedClient::maximizedChanged, this, &Decoration::updateTitleBar);
        connect(c, &KDecoration2Lim::DecoratedClient::maximizedChanged, this, &Decoration::setOpaque);

        connect(c, &KDecoration2Lim::DecoratedClient::widthChanged, this, &Decoration::updateButtonsGeometry);
        connect(c, &KDecoration2Lim::DecoratedClient::maximizedChanged, this, &Decoration::updateButtonsGeometry);
        connect(c, &KDecoration2Lim::DecoratedClient::adjacentScreenEdgesChanged, this, &Decoration::updateButtonsGeometry);
        connect(c, &KDecoration2Lim::DecoratedClient::shadedChanged, this, &Decoration::updateButtonsGeometry);
    ...
    {
        m_leftButtons = new KDecoration2Lim::DecorationButtonGroup(KDecoration2Lim::DecorationButtonGroup::Position::Left, this, &ButtonLim::create);
        m_rightButtons = new KDecoration2Lim::DecorationButtonGroup(KDecoration2Lim::DecorationButtonGroup::Position::Right, this, &ButtonLim::create);
    ...
    void Decoration::updateButtonsGeometry()
    {
        ...
        foreach( const QPointer<KDecoration2Lim::DecorationButton>& button, m_leftButtons->buttons() + m_rightButtons->buttons() )
        {
    ...
    void Decoration::createSizeGrip()
    {
        ...
        if( c->windowId() != 0 )
        {
            ...
            connect( c, &KDecoration2Lim::DecoratedClient::maximizedChanged, this, &Decoration::updateSizeGripVisibility );
            connect( c, &KDecoration2Lim::DecoratedClient::shadedChanged, this, &Decoration::updateSizeGripVisibility );
            connect( c, &KDecoration2Lim::DecoratedClient::resizeableChanged, this, &Decoration::updateSizeGripVisibility );
        }
        #endif
