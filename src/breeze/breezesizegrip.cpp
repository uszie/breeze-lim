...
namespace Breeze
{
        ...
        ,m_decoration( decoration )
    {
        ...
        connect( c, &KDecoration2Lim::DecoratedClient::widthChanged, this, &SizeGrip::updatePosition );
        connect( c, &KDecoration2Lim::DecoratedClient::heightChanged, this, &SizeGrip::updatePosition );
        connect( c, &KDecoration2Lim::DecoratedClient::activeChanged, this, &SizeGrip::updateActiveState );
